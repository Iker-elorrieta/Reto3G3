...
class EntradaTest {
	...
	Sesion obj1_s = new Sesion(null, null, null, null, 0);
	
Entrada ent0 = new Entrada("FDG557", (float) 4.7, arraySesiones);
	
	@Test
	void test_getters_y_setters() {
		arraySesiones[0]=obj1_s;
		Entrada ent = new Entrada("FDG557", (float) 4.7, arraySesiones);
	...
	@Test
	void test_equals() {
		Entrada ent1 = new Entrada(null, 0, arraySesiones);
		Entrada ent2 = new Entrada(null, 0, arraySesiones);
